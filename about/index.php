...
<div class="about-values">
    <h3 class="bebas-neue sub-titles">Core Values</h3>

    <div class="cards core-cards">
        <div class="card">
            <div class="text-1 simplon-mono-reg">Create</div>
        ...
        <div class="card">
        <div class="text-1 simplon-mono-reg">Build</div>
            <div class="text-2 simplon-mono-lite">with</div>
        ...
        <div class="card">
        <div class="text-1 simplon-mono-reg">Grow</div>
            <div class="text-2 simplon-mono-lite">with</div>
